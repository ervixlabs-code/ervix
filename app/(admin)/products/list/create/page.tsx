  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Ürün kaydı oluşturulamadı.")
      }

      router.push("/products/list")
    } catch (error) {
      console.error("Create product error:", error)
      alert("Ürün kaydı oluşturulurken hata oluştu.")
    } finally {
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl font-bold tracking-[-0.03em] sm:text-3xl xl:text-4xl">
              Yeni Product Kaydı Oluştur
            </h1>

            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-[15px]">
              Products sayfasında gösterilecek yeni ürün kaydını buradan
              oluşturabilirsin.
            </p>
          </div>
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Ürün adı, ikon, kategori ve açıklamaları doldur
                </p>
              </div>
            </div>
              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Çoklu alan ekleyip düzenleyebilirsin
                    </p>
                  </div>
                </div>
          ...
          <section className="flex flex-col gap-3 rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between sm:p-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                {isSubmitting ? "Kaydediliyor..." : "Product Kaydet"}
              </button>
            </div>
          </section>
        </div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-3">
                ...
                <div className="rounded-2xl bg-slate-50 px-4 py-3">
                  ...
                  <p className="mt-1 font-semibold text-slate-800">
                    {preview.features.filter(Boolean).length}
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-slate-50 px-4 py-3">
                  ...
                  <p className="mt-1 font-semibold text-slate-800">
                    {preview.goals.filter(Boolean).length}
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-slate-50 px-4 py-3">
                  ...
                  <p className="mt-1 font-semibold text-slate-800">
                    {preview.technologies.filter(Boolean).length}
                  </p>
                </div>
              </div>
            </section>
