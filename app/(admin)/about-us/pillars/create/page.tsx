...
export default function CreateAboutPillarPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Pillar kaydı oluşturulamadı.")
      }

      router.push("/about-us/pillars")
    } catch (error) {
      console.error("Create about pillar error:", error)
      alert("Pillar kaydı oluşturulurken hata oluştu.")
    } finally {
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl font-bold tracking-[-0.03em] sm:text-3xl xl:text-4xl">
              Yeni Pillar Kaydı Oluştur
            </h1>

            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-[15px]">
              Why ERVIX bölümünde yer alacak pillar kartını buradan oluşturabilirsin.
            </p>
          </div>
        ...
        <div className="space-y-6 2xl:col-span-7">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Başlık, açıklama ve ikon alanını doldur
                </p>
              </div>
            </div>
          ...
          <section className="flex flex-col gap-3 rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Form bilgilerini kontrol edip yeni pillar kaydını oluşturabilirsin.
              </p>
            </div>
