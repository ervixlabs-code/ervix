...
export default function CreateAboutCulturePage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Culture kaydı oluşturulamadı.")
      }

      router.push("/about-us/culture")
    } catch (error) {
      console.error("Create about culture error:", error)
      alert("Culture kaydı oluşturulurken hata oluştu.")
    } finally {
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl font-bold tracking-[-0.03em] sm:text-3xl xl:text-4xl">
              Yeni Culture Kaydı Oluştur
            </h1>

            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-[15px]">
              About sayfasındaki çalışma kültürü ve yaklaşım kartları için yeni kayıt
              oluşturabilirsin.
            </p>
          </div>
        ...
        <div className="space-y-6 2xl:col-span-7">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Section adı, badge, başlık ve açıklama alanlarını doldur
                </p>
              </div>
            </div>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-6">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold tracking-[-0.02em] text-slate-900">
                  Görsel ve Yapısal Alanlar
                </h2>
                <p className="mt-1 text-sm text-slate-500">
                  İkon, durum ve sıralama bilgilerini ayarla
                </p>
              </div>
            </div>
          ...
          <section className="flex flex-col gap-3 rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Form bilgilerini kontrol edip yeni culture kaydını oluşturabilirsin.
              </p>
            </div>
            ...
            <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-6">
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Web taraftaki yapı ile uyumlu alanlar
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-slate-50 p-4 text-sm leading-7 text-slate-600">
                ...
                içerikleri web tarafındaki kart yapısıyla birebir uyumlu olacak
