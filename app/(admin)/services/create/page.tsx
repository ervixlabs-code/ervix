  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(message || "Servis kaydı oluşturulamadı.")
      }

      await res.json()

      setSuccess(
        "Service kartı kaydedildi. Hero / stats / value / process / CTA alanları şu an preview amaçlı hazırlandı."
      )
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      setError(err?.message || "Servis oluşturulurken hata oluştu.")
    } finally {
      setSubmitting(false)
    }
  }
          ...
          <div className="space-y-6">
              ...
              <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
                <div className="max-w-3xl">
                  ...
                  <h1 className="text-2xl font-bold tracking-[-0.03em] sm:text-3xl xl:text-4xl">
                    Services Sayfası İçin Builder Ekranı
                  </h1>

                  <p className="mt-3 max-w-3xl text-sm leading-6 text-white/80 sm:text-[15px]">
                    Bu ekran artık yalnızca tek bir service kartı değil; hero, stats,
                    service preview, value blocks, process ve CTA mantığını da birlikte
                    görmene yardımcı olacak şekilde düzenlendi.
                  </p>
                </div>
            ...
            >
              <section className="space-y-4">
                <CollapsibleSection
                  title="Hero Bölümü"
                  subtitle="Services hero ve sağ perspective kartını yönet"
                ...
                <CollapsibleSection
                  title="Trust Stats"
                  subtitle="Üst istatistik / güven kartları"
                ...
                <CollapsibleSection
                  title="Service Card"
                  subtitle="Kaydedilecek asıl service item alanları"
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Örn: Kurumsal Web Siteleri"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="kurumsal-web-siteleri"
                          className="h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-800 outline-none transition focus:border-violet-400"
                        />
                      </div>
                    </div>
                ...
                <CollapsibleSection
                  title="Value Blocks"
                  subtitle="Service discipline altındaki bloklar"
                ...
                <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-slate-600">
                      Bu ekran artık page builder mantığında düzenlendi. Şu an save
                      işlemi mevcut backend yüzünden yalnızca service kartı verisini
                      kaydeder; diğer section’lar canlı preview amacıyla eklendi.
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6 flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Services sayfasının tamamına yakın builder preview
                    </p>
                  </div>
