...
export default function CreateStatsPage() {
  ...
  function mapStatusToApi(status: StatStatus) {
      ...
      if (!response.ok) {
        throw new Error(
          Array.isArray(result?.message)
            ? result.message.join(", ")
            : result?.message || "İstatistik kaydı oluşturulamadı."
        )
      }

      alert("İstatistik kaydı başarıyla oluşturuldu.")
      window.location.href = "/homepage/stats"
    } catch (error: any) {
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl font-bold tracking-[-0.03em] sm:text-3xl xl:text-4xl">
              Yeni İstatistik Oluştur
            </h1>

            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-[15px]">
              Anasayfadaki stats alanında yayınlanacak yeni kartı buradan
              oluşturabilirsin.
            </p>
          </div>
        ...
        <div className="2xl:col-span-7 space-y-6">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  İstatistik kartında görünecek alanları doldur
                </p>
              </div>
            </div>
          ...
          <section className="flex flex-col gap-3 rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Form bilgilerini kontrol edip yeni istatistik kartını oluşturabilirsin.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                {isSubmitting ? "Kaydediliyor..." : "İstatistik Kaydet"}
              </button>
            </div>
          </section>
        </div>
