...
export default function CreateTopSliderPage() {
  ...
  function mapStatusToApi(status: SliderStatus) {
      ...
      if (!response.ok) {
        throw new Error(
          Array.isArray(result?.message)
            ? result.message.join(", ")
            : result?.message || "Top slider kaydı oluşturulamadı."
        )
      }

      alert("Top slider kaydı başarıyla oluşturuldu.")
      window.location.href = "/homepage/top-slider"
    } catch (error: any) {
      console.error("Top slider create error:", error)
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-[15px]">
              Anasayfa üst slider alanında yayınlanacak yeni içeriği buradan
              oluşturabilirsin. Sağ tarafta canlı önizleme alanı da hazır.
            </p>
          </div>
        ...
        <div className="2xl:col-span-7 space-y-6">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Slider’da görünecek yazı alanlarını doldur
                </p>
              </div>
            </div>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-6">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Primary ve secondary CTA alanlarını belirle
                </p>
              </div>
            </div>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:p-6">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Durum ve sıralama bilgisini belirle
                </p>
              </div>
            </div>
          ...
          <section className="flex flex-col gap-3 rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Form bilgilerini kontrol edip yeni slide kaydını oluşturabilirsin.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                {isSubmitting ? "Kaydediliyor..." : "Slide Kaydet"}
              </button>
            </div>
          </section>
        </div>
